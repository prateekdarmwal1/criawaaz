<style>
    ...
    .grid_4 .alpha_sessions{width: 17% !important}
</style>
    ...
    <div id="demo-form">
        <div class="mws-form-block grid_4 ">
                    ...
                    <div class="mws-form-col-1-8 alpha sessions grid-3-item">
                        <div class="mws-form-item">
                            <input type="text" placeholder="Session" name="session" class="session mws-textinput readonly" id="assump-session">
                        </div>
                    </div>
        ...
        <div class="mws-form-block grid_2 match">
                   ...
                   <div class="mws-form-col-3-8 alpha">
                        <div class="mws-form-item">
                            <input type="text"   name="odd1" class="odd-1 mws-textinput readonly" id="assump-odd1">
                        </div>
                   </div>
                   <div class="mws-form-col-3-8">
                        <div class="mws-form-item">
                            <input type="text"      name="odd2"  class="mws-textinput odd-2 readonly" id="assump-odd2">
                        </div>
                   </div>
        </div>
        <div class="mws-block-form grid_2 fav">
                    ...
                    <div class="mws-form-col-3-8 alpha">
                        <div class="mws-form-item">
                            <input type="text" name='favorite' class="mws-textinput favorite readonly" id="assump-fav">
     ...
     <input type="button" value="Add More" class="mws-button red" style="float:right" id="assump-create" onfocusin="changeOnFocusIn('add')" onfocusout="changeOnFocusOut('add')">
                        </div>
            ...
            <div class="grid_">
                <div id="odds-panel">
                                ...
                                <div class="grid_4">
                                    ...
                                    <div class="mws-form-item" >
                                        <div class="mws-form-cols clearfix">
                                            <div class="mws-form-col-2-8 select alpha grid-6-item">

                                                <div class="mws-form-item" id="assumptions-data">
                                                    <?php
                                                    echo $this->Form->select('inning', $InningSelect, ["empty" => "Inning", "value" => $assump['inning'], "name" => "inning", "id" => "assump-inning".$assump['id'] , "class" => "inning mws-textinput", "style"=> "width:81px;"]);
                                                    ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mws-form-col-2-8 alpha  alpha_sessions">
                                                <div class="mws-form-item">
                    ...
                    <div class="mws-form-col-1-8 alpha grid-1-item">
                        <div class="mws-form-item">
                            <?php
                            echo $this->Form->select('score1Unit', $ScoreUnit, ["empty" => "", "id" => "assump-score1-hundreds-".$assump['id'] ,"value" => $score1unit, "class" => "mws-textinput", "style"=>"width:50px;"]);
                            ?>
                        </div>
                    </div>
                    <div class="mws-form-col-1-8 ">
                     ...
                     <div class="mws-form-col-1-8 alpha grid-1-item">
                        <div class="mws-form-item">
                            <?php
                            echo $this->Form->select('score2Unit', $ScoreUnit, ["empty" => "","id" => "assump-score2-hundreds-".$assump['id'] ,"value" => $score2unit ,"class" => "mws-textinput", "style"=>"width:50px;"]);
                            ?>
                        </div>
                    </div>
                                            <div class="mws-form-col-1-8 ">
                                    ...
                                    <div class="mws-form-item" style="margin-left: 101px;">
                                        <div class="mws-form-cols clearfix">
                                            <div class="mws-form-col-4-8 alpha">
                                                <div class="mws-form-item">
                                                    <input type="text"  value="<?= $assump['odd1'] ?>" name="odd1"      class="odd-1 mws-textinput" id="assump-odd1-<?= $assump['id'] ?>">
                                                </div>
                                            </div>
                                            <div class="mws-form-col-4-8">
                                                <div class="mws-form-item">
                                                    <input type="text"      name="odd2"  value="<?= $assump['odd2'] ?>" class="mws-textinput odd-2" id="assump-odd2-<?= $assump['id'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="grid_2 fav">
                                    ...
                                    <div class="mws-form-item" style="margin-left: 101px;">
                                        <div class="mws-form-cols clearfix">
                                            ...
                                            <div class="mws-form-col-4-8 alpha">
                                                 <input type="button" id="submit-btns-<?= $assump['id'] ?>" value="Submit" class="mws-button red" style="float:right" onclick="updateAssumption(<?=$assump['id']?>)" onfocusin="changeOnFocusIn(<?=$assump['id']?>)" onfocusout="changeOnFocusOut(<?=$assump['id']?>)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
        ...
        function callCreateAssumption(callback){
             var data = {
                            ...
                            score1: $('#assump-score2-hundreds').val()+$('#assump-score1').val(),
