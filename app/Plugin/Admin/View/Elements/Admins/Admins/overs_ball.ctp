<div class="mws-panel-header" style="min-height:30px;">
    <span class="mws-i-24 i-table-1" style="width:700px;">
    Update Runs/Balls/Wickets&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <label>&nbsp;&nbsp;&nbsp;Playing&nbsp;Team&nbsp;&nbsp;&nbsp;</label>
    <input type="text" class="mws-textinput readonly" id="playing-team-text" value="<?= $score["Score"]["playing_team"] ?>">&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div class="mws-form-row mws-form-col-4-8">
            ...
            <div class="mws-form-item">
                <div id="mws-ui-button-radio">
                    <?php for ($i = 0; $i < 9; $i++) { ?>
                    <button class="fast-btns fastbtns" run="<?= $i ?>">&nbsp;&nbsp;&nbsp;<?= $i ?>&nbsp;&nbsp;&nbsp;</button>
                    <?php } ?>
                </div>
            </div>
        </div>
...
<div class="mws-form-row mws-form-col-1-8">
            ...
            <div class="mws-form-item">
                <div id="mws-ui-button-radio">
                    <button class="fastbtns" id="wide-no-ball">&nbsp;&nbsp;&nbsp;Wide&nbsp;&nbsp;&nbsp;</button>
                </div>
            </div>
        </div>
        <div class="mws-form-row mws-form-col-1-8">
            ...
            <div class="mws-form-item">
                <div id="mws-ui-button-radio">
                    <button class="fastbtns" id="no-ball">&nbsp;&nbsp;&nbsp;No&nbsp;&nbsp;&nbsp;</button>
                </div>
            </div>
        </div>
        <div class="mws-form-row mws-form-col-1-8">
