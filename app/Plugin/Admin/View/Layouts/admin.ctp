...
<head>
	...
	// echo $this->Html->css('bootstrap-3.3.7.min.css');
	...
	// JavaScript Plugins -->
	// echo $this->Html->script('js/jquery-3.2.0.min.js');
	echo $this->Html->script('js/jquery-1.7.2.min.js');
	echo $this->Html->script('js/jquery-migrate-1.4.1.min.js');
	...
	// echo $this->Html->script('js/bootstrap-3.3.7.min.js');
	// Plugin Scripts -->
...
<div id="mws-wrapper">
	...
	<?=$this->element("side_menu_bar")?>
        <div id="mws-container" class="clearfix"  style="padding-top: 65px;">
            <div class="container">
