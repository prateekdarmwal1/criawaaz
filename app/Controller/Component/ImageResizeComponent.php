...
class ImageResizeComponent extends Component {
     ...
     * specified for the new image, the dimensions off the original image will be used, resulting in a copy
     ...
     * @access public
     *
     * @return image on success, false on failure. use ImageComponent::getErrors() to get an array
     * of errors on failure
     */
    public function resize($original, $new_filename, $new_width = 0, $new_height = 0, $quality = 100) {
        
      //  $original =  WWW_ROOT . $original;
    //    $new_filename =  WWW_ROOT . $new_filename;
     ...
     * @access public
     *
     * @return image new image on success, false on failure. use ImageComponent::getErrors() to get an array
     * of errors on failure
     */
